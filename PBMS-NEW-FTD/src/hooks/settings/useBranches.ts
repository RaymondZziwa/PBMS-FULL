...
import { fetchDataStart, fetchDataSuccess, fetchDataFailure } from "../../redux/slices/settings/branchSlice";
...
const data = useSelector((state: RootState) => state.branch);
