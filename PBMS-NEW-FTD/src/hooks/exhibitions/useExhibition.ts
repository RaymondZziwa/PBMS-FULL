...
import { fetchDataStart, fetchDataSuccess, fetchDataFailure } from "../../redux/slices/exhibition/exhibitionSlice";
  ...
  const fetchDataFromApi = async () => {
    ...
    try {
      const response = await apiRequest(
          ExhibitionEndpoints.EXHIBITION.fetch_all,
          "GET",
            '',
      );
...
const data = useSelector((state: RootState) => state.exhibition);
