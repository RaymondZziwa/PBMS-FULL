...
import AddorModifyDepartment from './AddorModify';
...
const DepartmentManagement = () => {
  ...
  const deletedepartment = async () => {
    try {
      if (modalProps.department) {
        await apiRequest(DepartmentEndpoints.deleteDepartment(modalProps?.department?.id), "DELETE", '');
        refresh();
      }
    } catch (error) {
      ...
      {/* Edit Button with Tooltip */}
            <div className="relative group">
              <button
                ...
                onClick={()=> setModalProps({ isOpen: true, mode: 'edit', department: department })}
              >
                <FaEdit />
              </button>
            ...
            <div className="relative group">
              <button
                ...
                onClick={() => {
                    setModalProps({isOpen: false, mode: '', department: department})
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          onClick={()=> setModalProps({ isOpen: true, mode: 'create', department: null })}
      ...
      <AddorModifyDepartment
        visible={modalProps.isOpen}
        Department={modalProps.department}
        onCancel={() => setModalProps({ isOpen: false, mode: "create", department: null })} />
